...
export function PostCard(
  ...
  return (
    ...
    >
      <article
        lang={language!}
        className="overflow-hidden border bg-[#FCF7F2] flex flex-col text-card-foreground rounded-lg group h-full duration-300 transition-all hover:shadow-sm pointer-coarse:shadow-sm break-inside-avoid-column mb-3 text-sm"
      >
        {mainImage?.asset ? (
          <>
